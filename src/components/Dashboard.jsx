...
const Board = ({ title, value }) => {
  return (
    <div className="relative top-[10%] rounded-md text-custom-purple  hover:text-white  bg-transparent border-gray-800 border-2 hover:bg-gradient-to-tr from-custom-purple   p-6 px-[160px] py-[240px] mr-2">
