...
const Overview = () => {
  return (
    <div className="relative max-w-[1200px] w-full h-[508px] top-[184px] left-[40px] mx-auto  grid lg:grid-cols- gap-2">
      ...
      <div className="w-full grid grid-flow-col grid-cols-3 px-4 object-cover">
        <div className="absolute top-[18%] rounded-md  text-white w-[49%]  mr-2 ml-2 right-2">
  ...
  return (
    <>
      <div className="relative rounded-md mb-2 ml-1 bg-slate-800 w-[570px]  h-[95px]">
        <div className="absolute top-1 left-1 text-blue-600">{title}</div>
        <div className="text-7xl absolute right-1 top-1 ">{value}</div>
      </div>
    </>
  );
}
